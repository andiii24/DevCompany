...
<body>
            ...
            <div class="col-lg-6 align-self-center">
              <div class="owl-carousel owl-banner">
                <div class="item header-text">
                  <h6>Welcome to Andi Development center</h6>
                  <h2>We provide<em>many</em> Technological solution <span>and Services</span>?</h2>
                  <p></p>
                ...
                <div class="item header-text">
                  ...
                  <h2>we build the <em>best Website </em> for <span>your company</span></h2>
                  <p></p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
                ...
                <div class="item header-text">
                  ...
                  <h2>best mobile app <em>for both</em>Android<span>IOS</span></h2>
  ...
  <div id="services" class="our-services section">
    <div class="services-right-dec">
      ...
      <img src="{{asset('images/services-right-dec.png') }}" alt="">
    </div>
    <div class="container">
      <div class="services-left-dec">
        <img src="{{asset('images/services-left-dec.png') }}" alt="">
      </div>
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h2>Services<em> We </em> Provide </span></h2>
        ...
        <div class="col-lg-12">
          <div class="owl-carousel owl-services">
            <div class="item">
              ...
              <div class="icon"><img src="{{asset('images/service-icon-01.png') }}" alt=""></div>
              {{-- <p>Feel free to use this template for your business</p> --}}
            </div>
            <div class="item">
              <h4>Mobile Application development</h4>
              <div class="icon"><img src="{{asset('images/service-icon-02.png') }}" alt=""></div>
              {{-- <p>Get to know more about the topic in details</p> --}}
            </div>
            <div class="item">
              <h4>Give various trainings</h4>
              <div class="icon"><img src="{{asset('images/service-icon-03.png') }}" alt=""></div>
              {{-- <p>Get to know more about the topic in details</p> --}}
            </div>
            <div class="item">
              <h4>Consultancy</h4>
              <div class="icon"><img src="{{asset('images/service-icon-04.png') }}" alt=""></div>
              {{-- <p>Feel free to use this template for your business</p> --}}
            </div>
            <div class="item">
              <h4>Optimizing your websites and mobile apps</h4>
              <div class="icon"><img src="{{asset('images/service-icon-01.png') }}" alt=""></div>
              {{-- <p>Get to know more about the topic in details</p> --}}
            </div>
            <div class="item">
            ...
            <div class="item">
              <h4>Testing your platform</h4>
              <div class="icon"><img src="{{asset('images/service-icon-03.png') }}" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
              <h4>Provide already built services for your institute</h4>
              <div class="icon"><img src="{{asset('images/service-icon-04.png') }}" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            {{-- <div class="item">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{{asset('images/about-left-image.png') }}" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
  ...
  <div id="portfolio" class="our-portfolio section">
    <div class="portfolio-left-dec">
      <img src="{{asset('images/portfolio-left-dec.png') }}" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
  ...
  <div id="pricing" class="pricing-tables">
    <div class="tables-left-dec">
      <img src="{{asset('images/tables-left-dec.png') }}" alt="">
    </div>
    <div class="tables-right-dec">
      <img src="{{asset('images/tables-right-dec.png') }}" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="menu">
                    <div class="active">
                      <div class="thumb">
                        <img src="{{asset('images/video-thumb-01.png') }}" alt="">
                        <div class="inner-content">
                          <h4>Project One</h4>
                          <span>SEO &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{asset('images/video-thumb-02.png') }}" alt="">
                        <div class="inner-content">
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{asset('images/video-thumb-03.png') }}" alt="Marketing">
                        <div class="inner-content">
                          <h4>Project Three</h4>
                          <span>Digital &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{asset('images/video-thumb-04.png') }}" alt="SEO Work">
                        <div class="inner-content">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="about footer-item">
            <div class="logo">
              <a href="#"><img src="{{asset('images/logo.png') }}" alt="Onix Digital TemplateMo"></a>
            </div>
  ...
  <link rel="stylesheet" href="{{asset('js/imagesloaded.js') }}">
